		...
		<section id="identidade">
			<div class="container">
				...
				<div class="tabela-identidade-preco">
					<ul>
						<li>
							<ul class="plano-basico wow rubberBand" data-wow-duration="1s" data-wow-delay=".2s">
								<li><strong>Básico</strong></li>
								<li>Logo &nbsp;&nbsp;<i class="fa fa-edit"></i></li>
								<li>+2 Artes adicionais</li>
								<li>Revisões ilimitadas</li>
								<li>Apenas 3x de</li>
								<li>R$ <strong class="preco">33,33</strong></li>
								<li>ou R$ 95,30 à vista</li>
								<li>
									<button type="button" class="botao turquesa full btnPagto" data-toggle="modal" data-target="#modoPagamento" value="95,30">Selecionar</button>
								</li>
							</ul>
						</li>
						<li>
							<ul class="plano-profissional wow rubberBand" data-wow-duration="1s" data-wow-delay=".4s">
								<li><strong>Profissional</strong></li>
								<li>Logo &nbsp;&nbsp;<i class="fa fa-edit"></i></li>
								<li>Cartão de visita &nbsp;&nbsp;<i class="fa fa-id-card-o"></i></li>
								<li>+6 Artes adicionais</li>
								<li>Revisões ilimitadas</li>
								<li>Apenas 3x de</li>
								<li>R$ <strong class="preco">70,00</strong></li>
								<li>ou R$ 199,04 à vista</li>
								<li>
									<button type="button" class="botao palha full btnPagto" data-toggle="modal" data-target="#modoPagamento" value="199,04">Selecionar</button>
								</li>
							</ul>
						</li>
						<li>
							<ul class="plano-business wow rubberBand" data-wow-duration="1s" data-wow-delay=".6s">
								<li><strong>Business</strong></li>
								<li>Logo &nbsp;&nbsp;<i class="fa fa-edit"></i></li>
								<li>Cartão de visita &nbsp;&nbsp;<i class="fa fa-id-card-o"></i></li>
								<li>Crachá &nbsp;&nbsp;<i class="fa fa-id-badge"></i></li>
								<li>Animação de logo &nbsp;&nbsp;<i class="fa fa-file-movie-o"></i></li>
								<li>Mascote 2D &nbsp;&nbsp;<i class="fa fa-paw"></i></li>
								<li>+10 Artes adicionais</li>
								<li>Revisões ilimitadas</li>
								<li>Apenas 3x de</li>
								<li>R$ <strong class="preco">146,66</strong></li>
								<li>ou R$ 415,94 à vista</li>
								<li>
									<button type="button" class="botao acafrao full btnPagto" data-toggle="modal" data-target="#modoPagamento" value="415,94">Selecionar</button>
								</li>
							</ul>
						</li>
						<li>
							<ul class="plano-personalizado wow rubberBand" data-wow-duration="1s" data-wow-delay=".8s">
								<li><strong>Personalizado</strong></li>
								<li>Logo &nbsp;&nbsp;<i class="fa fa-edit"></i></li>
								<li>Você escolhe quais tipos de artes atende melhor a sua necessidade!</li>
								<li>Revisões ilimitadas</li>
								<li>
									<button class="botao jato full">Selecionar</button>
								</li>
							</ul>
						</li>
					</ul>
		...
		<section id="producaov">
			<div class="container">
				...
				<div class="tabela-producaov-preco">
					<ul>
						<li>
							<ul class=" wow rubberBand" data-wow-duration="1s" data-wow-delay=".2s">
								<li><strong>Curta</strong></li>
								<li>5 segundos &nbsp;&nbsp;<i class="fa fa-clock-o"></i></li>
								<li>Introdução &nbsp;&nbsp;<i class="fa fa-youtube-square"></i></li>
								<li>Revisões ilimitadas</li>
								<li>Apenas 3x de</li>
								<li>R$ <strong class="preco">13,33</strong></li>
								<li>ou R$ 37,72 à vista</li>
								<li>
									<button type="button" class="botao rubi full btnPagto" data-toggle="modal" data-target="#modoPagamento" value="37,72">Selecionar</button>
								</li>
							</ul>
						</li>
						<li>
							<ul class=" wow rubberBand" data-wow-duration="1s" data-wow-delay=".4s">
								<li><strong>Média</strong></li>
								<li>10 segundos &nbsp;&nbsp;<i class="fa fa-clock-o"></i></li>
								<li>Introdução &nbsp;&nbsp;<i class="fa fa-youtube-square"></i></li>
								<li>Revisões ilimitadas</li>
								<li>Apenas 3x de</li>
								<li>R$ <strong class="preco">26,66</strong></li>
								<li>ou R$ 75,44 à vista</li>
								<li>
									<button type="button" class="botao rubi full btnPagto" data-toggle="modal" data-target="#modoPagamento" value="75,44">Selecionar</button>
								</li>
							</ul>
						</li>
						<li>
							<ul class=" wow rubberBand" data-wow-duration="1s" data-wow-delay=".6s">
								<li><strong>Longa</strong></li>
								<li>15 segundos &nbsp;&nbsp;<i class="fa fa-clock-o"></i></li>
								<li>Introdução &nbsp;&nbsp;<i class="fa fa-youtube-square"></i></li>
								<li>Revisões ilimitadas</li>
								<li>Apenas 3x de</li>
								<li>R$ <strong class="preco">40,00</strong></li>
								<li>ou R$ 113,16 à vista</li>
								<li>
									<button type="button" class="botao rubi full btnPagto" data-toggle="modal" data-target="#modoPagamento" value="113,16">Selecionar</button>
								</li>
							</ul>
						</li>
						<li>
							<ul class="dif wow rubberBand" data-wow-duration="1s" data-wow-delay=".8s">
								<li><strong>Apresentação</strong></li>
								<li>Máx. 45 segundos &nbsp;&nbsp;<i class="fa fa-clock-o"></i></li>
								<li>Apresentação &nbsp;&nbsp;<i class="fa fa-youtube-square"></i></li>
								<li>Você escolhe o tempo que precisa para sua apresentação!</li>
								<li>Revisões ilimitadas</li>
								<li>
									<button class="botao alcacuz full">Selecionar</button>
								</li>
							</ul>
						</li>
					</ul>
